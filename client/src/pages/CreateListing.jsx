    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                border' maxLength='62' minLength='10' required onChange={handleChange}
                value={formData.name}/>
                <textarea type='text' placeholder='Description' id='description' className='p-3 rounded-lg
                border' required onChange={handleChange} value={formData.description}/>
                <input type='text' placeholder='Address' id='address' className='p-3 rounded-lg
                border' required onChange={handleChange} value={formData.address}/>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <span className='font-normal text-gray-600 ml-2'>The first image will be 
                ...
                <div className='flex gap-4'>
                    ...
                    className='p-3 border border-green-700 text-green-700 uppercase
                    rounded hover:shadow-lg disabled:opacity-80'>{uploading? 'Uploading...': 'Upload'}</button>
                </div>
                <p className='text-red-700 text-sm'>{imageUploadError && imageUploadError}</p>
                {
                    formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
                        <div key={url} className='flex p-3 justify-between border items-center'>
                ...
                <button disabled={loading || uploading} className='p-3 rounded-lg bg-slate-700 text-white uppercase
