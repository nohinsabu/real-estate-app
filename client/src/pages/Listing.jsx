    ...
    <main>
        ...
        {listing && !loading && !error && (
            <div>
                ...
                {copied && (
                    <p className='fixed top-[33%] right-[5%] z-10 rounded-md bg-slate-100 p-2'>
                    Link copied!
                    </p>
                )}
                <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                    ...
                    && !contact && (
                        <button onClick={() => setContact(true)} className='p-3 bg-slate-700 text-white uppercase 
                    hover:opacity-90 rounded-lg'>Contact Landlord</button>
                    )}
