  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <Link className='bg-green-700 text-white rounded-lg p-3 
        text-center uppercase hover:opacity-90' to={'/create-listing'}>
        Create Listing</Link>
      </form>
      ...
      <div className='flex flex-col gap-4'>
        ...
        className='flex border p-3 justify-between items-center gap-4 rounded-lg'>
          <Link to={`listing/${listing._id}`}>
            <img src={listing.imageUrls[0]} alt='listing cover' 
            className='h-16 w-16 object-contain' />
          </Link>
          <Link className='text-slate-700 font-semibold hover:underline
            flex-1 truncate' to={`/listing/${listing._id}`}>
            <p>{listing.name}</p>
          </Link>
